...
function AddPrescription() {
  ...
  const [numAdministrationsPerDay, setNumAdministrationsPerDay] = useState("");
  ...
  const handleSubmit = (event) => {
    ...
    const patientIndex = patientFiles.findIndex(
  ...
  return (
    <div className="mt-20">
      <h1 className="font-bold text-[50px] text-center mb-8">
        Add prescription for {patientFile.name}
      </h1>
      <form onSubmit={handleSubmit} className="xl:mx-36">
        <div className="md:grid md:grid-cols-2 md:place-items-center ">
          <div className="order-2">
            <label>Medication Identifier</label>
            <br />
            <input
              type="text"
              value={medicationIdentifier}
              onChange={(e) => setMedicationIdentifier(e.target.value)}
            />
          </div>

          <div className="order-6">
            <label>Number of Administrations per Day</label>
            <br />
            <input
              type="number"
              value={numAdministrationsPerDay}
              onChange={(e) => setNumAdministrationsPerDay(e.target.value)}
            />
          </div>
          ...
          <div className="order-3">
            ...
            <input
              type="text"
              value={methodOfAdministration}
              onChange={(e) => setMethodOfAdministration(e.target.value)}
            />
          </div>
