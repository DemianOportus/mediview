...
function AddPatient() {
    ...
    const addPatientToFile = () => {
        const newPatient = {
            id: patientFiles.length + 1, // Generate a unique ID
            ...formData,
        };
            ...
            <form className="xl:mx-36" onSubmit={handleSubmit}>
                <div className="md:grid md:grid-cols-2 md:place-items-center ">
                    ...
                    <div className="order-6">
                        ...
                        <input type="email" name="doctorEmail" value={formData.doctorEmail} onChange={handleInputChange} />
                    </div>
                    <div className="order-8">
                        <label>Insurance number</label><br/>
                        <input type="number" name="insuranceNumber" value={formData.insuranceNumber} onChange={handleInputChange} />
                    </div>
                    <div className="order-10">
                        <label>Medical Proxy</label><br/>
                        <input type="name" name="medicalProxy" value={formData.medicalProxy} onChange={handleInputChange} />
                    </div>
                </div>
